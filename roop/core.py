...
def run():
    ...
    conditional_download(os.path.join(os.path.abspath(os.path.dirname(__file__)), "..", "models"), ["https://github.com/facefusion/facefusion-assets/releases/download/models/inswapper_128.onnx"])
